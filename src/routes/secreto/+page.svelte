<script lang="ts">
	...
	const final = `Today is the ${day}${append(day)} of ${months[month]}.`;
	...
	<div class="flex w-full h-full">
		<div class="w-1/2 h-full bg-teal-900 ">
			<div class="grid w-full h-full grid-cols-4 grid-rows-4 gap-4 p-4 bg-transparent">
				...
				<div class="flex flex-col items-center justify-center col-span-1 row-span-2 p-4 bg-teal-50 rounded-2xl">
		...
		<div class="w-1/2 h-full bg-teal-50">
			<div class="grid w-full h-full grid-cols-4 grid-rows-4 gap-4 p-4 bg-transparent">
				<div class="flex-col col-span-2 row-span-2 p-3 text-center bg-teal-900 rounded-2xl">
					<h1 class="mb-4 text-4xl font-bold text-white">Tasks</h1>
                ...
                <div class="flex items-center justify-center col-span-1 row-span-1 row-start-3 transition bg-teal-900 rounded-2xl active:scale-90 hover:cursor-pointer">
                    <a href="https://todoist.com/app/today">
                        <iconify-icon icon="cib:todoist" width="84" height="84" class="text-white"></iconify-icon>
                    </a>
                </div>
			</div>
		</div>
